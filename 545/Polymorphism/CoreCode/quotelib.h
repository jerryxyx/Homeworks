...
public:
    Stock(string stockName="default",float bidPrice=0, float askPrice=0, float lastPrice=0, float issueExchange=0)
        : Quote("stock",stockName),bidPrice(bidPrice),askPrice(askPrice),lastPrice(lastPrice),issueExchange(issueExchange){}
    void reDim(string stockName="default",float bidPrice=0, float askPrice=0, float lastPrice=0, float issueExchange=0){
        name = stockName;
        bidPrice=bidPrice;
        askPrice=askPrice;
        lastPrice=lastPrice;
...
public:
    Option(string optionName="default", string underlyingName="default", float bidPrice=0, float askPrice=0, float lastPrice=0, float contractSize=0, float expireDate=0)
    ...
    void reDim(string optionName="default", string underlyingName="default", float bidPrice=0, float askPrice=0, float lastPrice=0, float contractSize=0, float expireDate=0){
        name = optionName;
...
public:
    Quote* createStock(string stockName="default",float bidPrice=0, float askPrice=0, float lastPrice=0, float issueExchange=0){
        return new Stock(stockName,bidPrice,askPrice,lastPrice,issueExchange);
    }
    Quote* createOption(string optionName="default", string underlyingName="default", float bidPrice=0, float askPrice=0, float lastPrice=0, float contractSize=0, float expireDate=0){
